...
CKERROR CreateTTLinearVolumeBehaviorProto(CKBehaviorPrototype **pproto);
int TTLinearVolume(const CKBehaviorContext& behcontext);

CKObjectDeclaration *FillBehaviorTTLinearVolumeDecl()
{
    ...
    od->SetCreationFunction(CreateTTLinearVolumeBehaviorProto);
...
CKERROR CreateTTLinearVolumeBehaviorProto(CKBehaviorPrototype **pproto)
{
    ...
    proto->SetFunction(TTLinearVolume);
...
CKERROR TTLinearVolumeCallBack(const CKBehaviorContext& behcontext)
{
    CKBehavior* beh = behcontext.Behavior;
    // TODO: To be finished.
    return CKBR_OK;
