...
CKERROR CreateTTTimerBehaviorProto(CKBehaviorPrototype **pproto);
int TTTimer(const CKBehaviorContext& behcontext);

CKObjectDeclaration *FillBehaviorTTTimerDecl()
{
    ...
    od->SetCreationFunction(CreateTTTimerBehaviorProto);
...
CKERROR TTTimerCallBack(const CKBehaviorContext& behcontext)
{
    CKBehavior* beh = behcontext.Behavior;
    // TODO: To be finished.
    return CKBR_OK;
