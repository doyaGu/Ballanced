...
#define RESDLL_EXPORT extern __declspec(dllexport)
#else
#define RESDLL_EXPORT extern __declspec(dllimport)
#endif
...
RESDLL_EXPORT void fillResourceMap(RESOURCEMAP *pResMap);
