...
ballance_set_cache_default(BALLANCE_ENABLE_SDL3 ON BOOL
        "Build the SDL3 system backend")

if (BALLANCE_ENABLE_SDL3)
...
ballance_set_cache_default(VXMATH_ENABLE_SDL3 ${BALLANCE_ENABLE_SDL3} BOOL "")
ballance_set_cache_default(CK2_ENABLE_SDL3 ${BALLANCE_ENABLE_SDL3} BOOL "")
ballance_set_cache_default(PLAYER_ENABLE_SDL3 ${BALLANCE_ENABLE_SDL3} BOOL "")
ballance_set_cache_default(CKRE_ENABLE_SDL3 ${BALLANCE_ENABLE_SDL3} BOOL "")
ballance_set_cache_default(CKMANAGERS_ENABLE_SDL3 ${BALLANCE_ENABLE_SDL3} BOOL "")
ballance_set_cache_default(CKBB_ENABLE_SDL3 ${BALLANCE_ENABLE_SDL3} BOOL "")
ballance_set_cache_default(CKPLUGINS_ENABLE_SDL3 ${BALLANCE_ENABLE_SDL3} BOOL "")
...
if (BALLANCE_ENABLE_SDL3)
    ...
    ballance_set_cache_default(DX8INPUT_BUILD_SHARED OFF BOOL "")
    ballance_set_cache_default(DX8INPUT_BUILD_STATIC OFF BOOL "")
    ballance_set_cache_default(DX8INPUT_INSTALL OFF BOOL "")
    ballance_set_cache_default(DX8SOUND_BUILD_SHARED OFF BOOL "")
    ballance_set_cache_default(DX8SOUND_BUILD_STATIC OFF BOOL "")
    ballance_set_cache_default(DX8SOUND_INSTALL OFF BOOL "")
    if (NOT WIN32)
